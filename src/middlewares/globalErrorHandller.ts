...
export const globalErrorHandller = (err: any, req: Request, res: Response, next: NextFunction) => {
    ...
    if (err instanceof Prisma.PrismaClientValidationError) {
        ...
        if (err.errorCode === "P1000") {
            ...
            statusCode = httpStatus.BAD_REQUEST,
                errorMessage = "Can't reach database server. Please make sure your database server is running at correct port."
        }
    } else if (err instanceof Prisma.PrismaClientUnknownRequestError) {
        statusCode = httpStatus.INTERNAL_SERVER_ERROR,
            errorMessage = "Error occurred during query execuriton"
    }
